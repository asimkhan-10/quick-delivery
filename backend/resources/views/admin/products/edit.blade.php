...
<head>
    ...
    <title>Edit Product - QUICK DELIVERY Admin</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .current-image, .image-preview { margin-top: 1rem; max-width: 200px; border-radius: 8px; }
        .image-info { font-size: 0.875rem; color: #718096; margin-top: 0.5rem; }
    </style>
</head>
<body>
    <div class="container">
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @if($product->image_url)
                        <div>
                            <img src="{{ asset($product->image_url) }}" alt="Current Image" class="current-image">
                            <div class="image-info">Current image (leave empty to keep current image)</div>
                        </div>
                    @endif
