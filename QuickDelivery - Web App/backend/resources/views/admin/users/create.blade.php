...
<head>
    ...
    <title>Add User - QUICK DELIVERY Admin</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .image-preview { margin-top: 1rem; max-width: 150px; border-radius: 50%; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="form-container">
            <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="profile_photo" name="profile_photo" class="form-control" accept="image/*" onchange="previewImage(this)">
                    @error('profile_photo')
                        <div class="error">{{ $message }}</div>
                    @enderror
